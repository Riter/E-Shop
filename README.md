...
*   Docker (версия X.Y.Z или выше)
*   Docker Compose (версия X.Y.Z или выше)
...
*Этот README был сгенерирован и может потребовать дополнительной корректировки и уточнений.* 